/**
 * PresentationController - Course Lecture Presentation Engine
 *
 * Features:
 ...
 *
 * Usage:
 * Include this script in your lecture HTML files.
 * It will automatically initialize when the DOM is ready.
 */
...
class PresentationController {
    constructor() {
        ...
        this.currentTheme = localStorage.getItem('courseTheme') || 'light';
    ...
    applyTheme() {
        document.documentElement.setAttribute('data-theme', this.currentTheme);
        localStorage.setItem('courseTheme', this.currentTheme);
    }
